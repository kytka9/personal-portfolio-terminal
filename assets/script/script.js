  ...
  sk: {
    ...
    contact: `
          ...
          <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 10px;">
            ...
            <p><i class="fas fa-file-pdf" style="width: 25px; color: var(--warp-accent);"></i> <strong>Resume :</strong> <a href="./assets/resume/html/resume_sk.html" target="_blank" class="highlight">Otvoriť životopis</a></p>
  ...
  en: {
    ...
    contact: `
          ...
          <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 10px;">
            ...
            <p><i class="fas fa-file-pdf" style="width: 25px; color: var(--warp-accent);"></i> <strong>Resume :</strong> <a href="./assets/resume/html/resume_en.html" target="_blank" class="highlight">Open Resume</a></p>
